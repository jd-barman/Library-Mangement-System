...
void Lib::modify() //Modify Details
{
    char ch, st1[100];
    int i = 0, b, cont = 0;
    system("cls");
    ...
    else if (i == 2) //Addition of new details
    {
        system("cls");
        B = branch(2);
        system("cls");
    ...
    else if (i == 3) //Deletion of old details
    {
        system("cls");
        b = branch(2);
        ifstream intf1("Booksdata.txt", ios::binary);
...
int Lib::branch(int x) //Branch Selection
{
    int i;
...
void Lib::issue() //Issue Book
{
    ...
    else if (i == 3) //Search Student Who Issued Books
    {
        system("cls");
        fflush(stdin);
...
void Lib::fine(int d, int m, int y, int dd, int mm, int yy) //Fine for late submission
{
    long int n1, n2;
    int years, l, i;
...
void Lib::pass() //Librarian Menu
{
    int i = 0;
    char ch, st[21], ch1[21] = {"HelloWorld"};
    cout << "\n\t\tEnter Password : ";
    while (1)
    {
        ch = getch();
...
void Lib::password() //Change Password
{
    int i = 0, j = 0;
    char ch, st[21], ch1[21] = {"HelloWorld"};
    system("cls");
